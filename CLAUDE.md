...
The theme lives at `wp-content/themes/boilerplate-wordpress/` inside a Local (Flywheel) site at `/Users/luismorales/Local Sites/template-wp/`. Local URL: `http://template-wp.local/`.
